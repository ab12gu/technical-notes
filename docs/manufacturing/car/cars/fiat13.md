...
- [How to drive stick, business insider, fiat](https://www.youtube.com/watch?v=4Btj-ost5Sg)
- Shifts down into 4th, but cannot shift out of it after!
...
![shifter-fiat image](images/shifter-fiat.jpeg){: style="width:400px"}

Top View:

![top-view image](images/top-view.jpeg){: style="width:400px"}

Top Driver Side View:

![top-driver-side-looking-down](images/top-driver-side-looking-down.jpeg){: style="width:400px"}

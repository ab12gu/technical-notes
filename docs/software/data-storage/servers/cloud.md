...
The one that keeps showing up on top is [render](render.com). <br>
I thought I recalled it didn't freeze the servers after a certain amount of time... but seems it does?...

Essentially, it (as with most alternative mainstream server systems) use AWS server system and create a different interface to interact with including a different business/charging plan. They give better free allocations, but "probably" have higher charges for paying customers. 
